...
#################################################################################
{
    ...
    'summary': """Allows user to print X-Report, Z-Report, Sales Summary report,
            Product Summary Report,Order Summary Report and Payment Summary Report.""",
    'description': """
...
""",
    ...
    'data': [
        ...
        'views/pos_session_report_pdf_template.xml',
        ...
        'views/sales_detail_view.xml',
        'views/pos_static_register.xml',
        'wizard/wizard_pos_sale_report_view.xml',
        'wizard/wizard_pos_session_report_view.xml',
